  ...
  return (
    <main className={style.container}>
      ...
      <section className={style.container_box}>
        <Image src={ImageSabor} className={style.largura_box}/>
        <div className={`${style.largura_box} ${style.box_text}`}>
        ...
        <Image src={ImageEvento} className={style.largura_box}/>
        <Image src={ImageSobre} className={style.largura_box}/>
        <div className={`${style.largura_box} ${style.box_text}`}>
          <h2>Sobre Nós</h2>
